...
export default function HeroSection() {
  return (
    <section className="w relative w-screen overflow-hidden bg-gradient-to-b from-[#0B0A0A] to-[#0d0d1a] px-4 pt-36 text-white sm:px-6 lg:px-8 lg:pt-22">
      ...
      <div className="relative z-10 mx-auto flex max-w-4xl flex-col items-center text-center">
        ...
        {/* Main Heading */}
        <h1 className="mb-6 text-center text-[45px] leading-[46px] font-medium -tracking-wide text-white md:text-[4.5rem] md:leading-[72px]">
          Your business, boosted by <br className="hidden md:block" /> AI that
          actually gets it
        </h1>

        {/* Sub-paragraph */}
        <p className="mb-8 max-w-2xl text-center lg:text-xl text-md leading-[28px] -tracking-wide text-gray-300 md:text-2xl md:leading-[34px]">
        ...
        <Link href="/demo" passHref>
          <Button className="rounded-2 mb-12 cursor-pointer bg-[#7D73C3] px-8 py-8 text-sm lg:text-lg font-normal text-white shadow-lg transition duration-300 ease-in-out hover:bg-[#7b68ee] md:text-xl">
            Try DoubleU AI
          </Button>
        </Link>

        {/* Feature Highlights */}
        <div className="flex items-center justify-center gap-6 text-gray-300 md:flex-row md:gap-12">
          ...
          <div className="flex items-center space-x-2">
            <Image
              ...
              className="object-cover"
            />
            <span className="lg:text-base text-sm">Cloud-Based & Secure</span>
          </div>
          <div className="flex items-center space-x-2">
            <Image
              src="/new-img/icon-check.svg"
              ...
              className="object-cover"
            />
            <span className="lg:text-base text-sm">AI Solution</span>
          </div>
        </div>
      </div>

      <div className="relative z-0 mt-20 flex justify-center md:mt-8">
