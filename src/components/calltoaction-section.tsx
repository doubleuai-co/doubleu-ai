...
export default function CallToActionSection() {
  return (
    <section className="relative lg:mx-auto mx-6 my-20 max-w-6xl overflow-hidden rounded-3xl bg-[#7D73C3] px-4 py-12 text-white shadow-xl sm:px-6 lg:px-8">
      <div className="container mx-auto flex flex-col items-center justify-between md:flex-row">
        {/* Text Content */}
        <div className="pt-8 lg:pt-0 px-8 mb-8 flex flex-col items-center text-center md:mb-0 md:w-1/2 md:items-start md:text-left">
