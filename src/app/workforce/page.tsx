...
export default function Workforce() {
  ...
  return (
    <main className="bg-white">
      ...
      <section className="relative flex w-full items-center justify-center bg-black text-white md:h-[120vh]">
        <Image
        ...
        {/* Main Content */}
        <div className="relative mx-auto max-w-[52rem] px-4 pt-40 pb-20 text-center">
      ...
      <section>
        ...
        <section className="bg-white px-2 py-[49px] text-[#0B0A0A] sm:px-2 md:py-[118px] lg:px-8">
        ...
        <section className="bg-white px-6 sm:px-6 md:px-[120px]">
          ...
          <div className="container mx-auto grid max-w-7xl grid-cols-1 bg-[#F9F9F9] md:hidden md:grid-cols-2">
            ...
            <div className="flex flex-col space-y-6 md:p-12">
              <h2 className="mb-4 px-6 pt-8 pb-2 text-center text-2xl font-bold text-[0B0A0A] md:text-start md:text-4xl">
                Our Workers general features
              </h2>
              ...
              <ul className="space-y-4 py-6 md:py-0">
                {generalFeatures.map((feature, index) => (
                  <li
                    key={index}
                    className="ml-4 flex w-max items-center space-x-3 rounded-sm bg-[#FFFFFF] p-2"
                  >
                    <Image
                      src="/new-img/bullet.svg"
                      alt=""
      ...
      <section className="relative mx-4 my-[47px] flex max-w-6xl items-center justify-center overflow-hidden rounded-[20px] bg-[linear-gradient(171.67deg,_#160F0F_35.65%,_#7D73C3_93.62%)] px-4 py-18 text-white md:mx-[120px] md:mt-[87px] md:mb-[49px] md:px-[120px]">
