...
export default function Mylo() {
  ...
  return (
    <div className=" text-gray-800">
        ...
        <div className="container mx-auto grid max-w-6xl pt-8 grid-cols-1 items-center justify-between gap-8 md:grid-cols-2">
          ...
          <div className="text-left">
            ...
            <p className="text-md mb-4  leading-relaxed text-gray-700">
              Who is Mylo? Mylo is your always-on sales assistant, built to
              deliver warm, attentive, and personalized service throughout the
              customer journey. From handling inquiries to processing payments
              and offering tailored support, Mylo makes every interaction
              efficient and delightful.
              <br />
              As a 24/7 extension of your sales team, she enhances experiences,
              guides prospects, and seamlessly connects users to real team
              members when needed.
              <br />
              Integrating Mylo helps streamline inquiries, reduce response
              times, and boost customer satisfaction, while keeping your brand
      ...
      <section className="mx-auto max-w-[85rem] bg-white px-8 py-14 sm:px-6 md:px-4 lg:px-8">
