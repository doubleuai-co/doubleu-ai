    ...
    <>
      <div className="bg-white">
        ...
        {/* 8. Bottom CTA Banner */}          
          ...
          viewport={{ once: true, amount: 0.5 }}
          variants={fadeIn}
          className="relative mx-4 flex items-center justify-center overflow-hidden rounded-[20px] bg-[linear-gradient(171.67deg,_#160F0F_35.65%,_#7D73C3_93.62%)] px-4 py-18 text-white md:mx-[120px] md:mb-[49px] md:mt-[49px] my-[47px] md:px-[120px]"
        >
